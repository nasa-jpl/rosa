...
For patch contributions, see our [Developer Documentation](https://github.com/nasa-jpl/rosa/wiki/Developer-Documentation) for more details on how to set up your local environment, to best contribute to our project. 

At a minimum however to submit patches (if using Git), you'll want to ensure you have:
1. An account on GitHub.
2. Git installed on your local machine.
3. The ability to edit, build, and test ROSA on your local machine. Again, see our [README.md](README.md) or detailed developer guide for more details 
...
- [Issue tracking system](https://github.com/nasa-jpl/rosa/issues) - a regularly monitored area to report issues with our software or propose changes
- [Discussion forum](https://github.com/nasa-jpl/rosa/discussions) - a place to ask questions, propose new features, or discuss the project with other contributors
...
Make sure people are aware you're working on a patch! Check out our [issue tracking system](https://github.com/nasa-jpl/rosa/issues) and find an open issue you'd like to work against, or alternatively file a new issue and mention you're working on a patch.
...
Please make sure to provide a meaningful text description to your pull requests, whenever submitted. Our pull-request template will be auto-generated for you when you create your pull-request. See the template 
[here](.github/PULL_REQUEST_TEMPLATE.md). 
...
See our list of issues at: https://github.com/nasa-jpl/rosa/issues
...
- **Check for duplicates** - there may be a bug report already describing your issue, so check the [issue tracking system](https://github.com/nasa-jpl/rosa/issues) first.

Here's some guidance on submitting a bug issue:
1. Navigate to our [issue tracking system](https://github.com/nasa-jpl/rosa/issues) and file a new issue
...
- **Check for duplicates** - there may be a new feature issue already describing your issue, so check the [issue tracking system](https://github.com/nasa-jpl/rosa/issues) first
...
Take a look at our [pull requests tracking system](https://github.com/nasa-jpl/rosa/pulls), and try the following options for providing a review:
...
⚠️ It's **highly** advised that you take a look at our [issue tracking system](https://github.com/nasa-jpl/rosa/issues) before considering any code contributions. Here's some guidelines:
...
⚠️ It's **highly** advised that you take a look at our [issue-tracking system](https://github.com/nasa-jpl/rosa/issues) before considering any documentation contributions. Here's some guidelines:
...
- Hosted documentation
  - [ROSA Wiki Main-page](https://github.com/nasa-jpl/rosa/wiki) - Wiki pages for more detailed information about the project
    - [Developer Documentation](https://github.com/nasa-jpl/rosa/wiki/Developer-Documentation) - a page detailing how to set up your local development environment 
    - [Supported Models](https://github.com/nasa-jpl/rosa/wiki/Supported-Models) - a page detailing the Language Models supported by ROSA
...
1. Clone the ROSA wiki repository to your local machine `git clone https://github.com/nasa-jpl/rosa.wiki.git`
2. Create a new branch `git checkout -b my-new-docs`
3. Make your modifications in your local clone
4. Push your changes back to the repository on GitHub `git push origin my-new-docs`
5. Create a pull request on the repository on GitHub
...
- **Agent** - refers to any particular instance of the ROSA Agent, and should be capitalized
...
- Answer open questions in our [discussion forum](https://github.com/nasa-jpl/rosa/discussions)
- Answer open questions mentioned in our [issue tracking system](https://github.com/nasa-jpl/rosa/issues)
